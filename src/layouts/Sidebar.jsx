  ...
  return (
    <div>
      ...
      <motion.div 
        ...
        <div className='flex items-center gap-2.5 font-medium border-b border-black py-3 mx-3'>
          ...
          {/* remove line 39 if have logo */}
           <SiNetflix size={45} className='min-w-max'/>
        ...
        <div className='flex flex-col h-full'>
          ...
          <ul className='whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col font-medium overflow-x-hidden font-mono'>
            ...
            <li>
              ...
              <AiOutlineHome size={23} className=' text-gray-500 min-w-max' />
              Home
              </NavLink>
            ...
            <li>
              ...
              <MdOutlineLocalMovies size={23} className=' text-gray-500 min-w-max' />
              Movies
              </NavLink>
            ...
            <li>
              ...
              <PiTelevisionSimpleBold size={23} className=' text-gray-500 min-w-max' />
              TV Shows
              </NavLink>
            ...
            {
              isOpen && (
                <div className='border-b py-2 m-2.5 mb-5 border-black'>
            </div>
              )
            }
            ...
            <li>
              ...
              <BsPerson size={23} className=' text-gray-500 min-w-max' />
              Profile
              </NavLink>
      ...
      transition={{
       ...
       onClick={() => setIsOpen(!isOpen)} className='absolute w-fit h-fit z-50 right-2 bottom-5 md:block hidden' >
        {/* icon */}
